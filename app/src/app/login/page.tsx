        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="hidden lg:flex lg:w-[45%] hero-gradient relative items-center justify-center p-12">
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute top-1/3 right-1/4 w-40 h-40 bg-white/[0.05] rounded-full" />
                </div>
                <div className="relative text-center text-white max-w-md">
                    ...
                    <h1 className="text-4xl font-extrabold font-heading mb-3">
                        Cover<span className="text-emerald-200">matt</span>
                    </h1>
                    <p className="text-white/60 text-sm leading-relaxed mb-8">
                        Kenya&apos;s #1 hardware and electrical store. Sign in to track orders, save favorites, and enjoy exclusive deals.
                    </p>
                    <div className="grid grid-cols-3 gap-4 text-center">
                        {[
                            ...
                            <div key={s.label} className="bg-white/10 backdrop-blur-sm rounded-xl py-3">
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
                <div className="w-full max-w-md">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-heading">Welcome back</h2>
                    ...
                    <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
                        {(['email', 'phone'] as const).map(m => (
                            <button
                                ...
                                className={`flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all ${loginMethod === m ? 'bg-white shadow-sm text-gray-900' : 'text-gray-400'}`}
                            >
                                {m === 'email' ? 'Email' : 'Phone'}
                            </button>
                        ))}
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center"><span className="bg-gray-50 px-4 text-xs text-gray-400 font-medium">or continue with</span></div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-8">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 border border-blue-100 bg-blue-50/50 rounded-xl py-3 text-sm font-semibold text-blue-700 hover:bg-blue-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {isFacebookLoading ? (
                                <svg className="w-5 h-5 animate-spin text-blue-400" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"/></svg>
                            ) : (
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {isGoogleLoading ? (
                                <svg className="w-4 h-4 animate-spin text-gray-400" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"/></svg>
                            ) : (
                    ...
                    <p className="text-center text-sm text-gray-500">
                        Don&apos;t have an account? <Link href="/register" className="text-emerald-600 font-bold hover:underline">Create one free</Link>
                    </p>
                </div>
            </div>
        </div>
