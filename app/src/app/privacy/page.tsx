...
const SECTIONS = [
    {
        ...
        content: `We collect personal information that you voluntarily provide when placing orders, creating an account, or contacting us:

• **Personal details**: Name, email address, phone number, delivery address
• **Payment information**: M-Pesa number, card details (processed securely — we do not store card numbers)
• **Order history**: Products purchased, order dates, delivery preferences
• **Device information**: Browser type, IP address, and cookies for analytics`,
    },
    {
        icon: <Eye className="w-5 h-5 text-emerald-500" />,
        title: 'How We Use Your Information',
        content: `• Process and fulfill your orders
...
• Prevent fraud and ensure security`,
    },
    {
        ...
        title: 'Data Security',
        content: `• All data transmitted using **256-bit SSL/TLS encryption**
• Payment transactions processed through PCI-DSS compliant processors
...
• **Access** your personal data via your account
...
• **Request** a copy of your data`,
    },
    {
        ...
        content: `We use cookies to remember your login session and cart, analyze traffic via Google Analytics, and personalize your experience. You can control cookies through your browser settings.`,
    },
    {
        icon: <Bell className="w-5 h-5 text-emerald-500" />,
        title: 'Updates to This Policy',
        content: `We may update this Privacy Policy periodically. Changes will be posted on this page with an updated date.

**Last updated:** February 2026

Contact our Data Protection Officer at privacy@covermatt.co.ke.`,
    },
];
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-14">
                <div className="bg-emerald-50 rounded-2xl border border-emerald-100 p-5 mb-8 flex items-start gap-3">
                    ...
                    <p className="text-sm text-emerald-800">
                        <strong>Your privacy matters.</strong> Covermatt Hardware & Electricals is committed to protecting your personal data.
                    </p>
                </div>
